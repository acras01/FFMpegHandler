...
static const struct Field FieldMap[94] = {
  ...
  {
    .key = CHECKSUM,
    .value_format = F_UINT16,
    .encoded_format = F_UINT16,
    .len = 2,
    .range = {
      {.type = F_UINT16, .uint16_value = 0},
      {.type = F_UINT16, .uint16_value = 65535}
    },
  },
  {
    .key = CHECKSUM,
  ...
  {
    .key = UNIX_TIME_STAMP,
    .value_format = F_UINT64,
    .encoded_format = F_UINT64,
    .len = 8,
    .range = {
      {.type = F_UINT64, .uint64_value = 0},
      {.type = F_UINT64, .uint64_value = 18446744073709551615U}
    },
  },
  {
    .key = MISSION_ID,
    .value_format = F_CHAR_P,
    .encoded_format = F_CHAR_P,
    .len = 127,
    .range = {
      {.type = F_UINT8, .uint8_value = 0},
      {.type = F_UINT8, .uint8_value = 127}
    },
  },
  {
  ...
  },
  {
    ...
    .value_format = F_FLOAT,
    .encoded_format = F_UINT16,
    .len = 2,
    .range = {
      {.type = F_FLOAT, .float_value = 0},
      {.type = F_FLOAT, .float_value = 360}
    },
  },
  {
  ...
  },
  {
    ...
    .len = 2,
    .range = {
      {.type = F_FLOAT, .float_value = -50},
      {.type = F_FLOAT, .float_value = 50}
    },
  },
  {
    .key = PLATFORM_TRUE_AIRSPEED,
    .value_format = F_UINT8,
    .encoded_format = F_UINT8,
    .len = 1,
    .range = {
      {.type = F_UINT8, .uint8_value = 0},
      {.type = F_UINT8, .uint8_value = 255}
    },
  },
  {
  ...
  {
    .key = SENSOR_LATITUDE,
    .value_format = F_DOUBLE,
    .encoded_format = F_INT32,
    .len = 4,
    .range = {
      {.type = F_DOUBLE, .double_value = -90},
      {.type = F_DOUBLE, .double_value = 90}
    },
  },
  {
    ...
    .len = 4,
    .range = {
      {.type = F_DOUBLE, .double_value = -180},
      {.type = F_DOUBLE, .double_value = 180}
    },
  },
  {
    ...
    .len = 2,
    .range = {
      {.type = F_DOUBLE, .double_value = -900},
      {.type = F_DOUBLE, .double_value = 19000}
    },
  },
  {
  ...
  },
  {
    ...
    .value_format = F_DOUBLE,
    .encoded_format = F_UINT32,
    .len = 4,
    .range = {
      {.type = F_DOUBLE, .double_value = 0},
      {.type = F_DOUBLE, .double_value = 360}
    },
  },
  {
  ...
  },
  {
    ...
    .range = {
      {.type = F_DOUBLE, .double_value = 0},
      {.type = F_DOUBLE, .double_value = 5000000}
    },
  },
  {
    .key = TARGET_WIDTH,
    ...
    .range = {
      {.type = F_FLOAT, .float_value = 0},
      {.type = F_FLOAT, .float_value = 10000}
    },
  },
  {
  ...
  },
  {
    ...
    .len = 2,
    .range = {
      {.type = F_FLOAT, .float_value = -900},
      {.type = F_FLOAT, .float_value = 19000}
    },
  },
  {
    ...
    .len = 2,
    .range = {
      {.type = F_FLOAT, .float_value = -0.075},
      {.type = F_FLOAT, .float_value = 0.075}
    },
  },
  {
  ...
  },
  {
    ...
    .value_format = F_INT8,
    .encoded_format = F_INT8,
    .len = 1,
    .range = {
      {.type = F_INT8, .int8_value = -128},
      {.type = F_INT8, .int8_value = 127}
    },
  },
  {
  ...
  },
  {
    ...
    .range = {
      {.type = F_UINT16, .uint16_value = 0},
      {.type = F_UINT16, .uint16_value = 512}
    },
  },
  {
  ...
  },
  {
    ...
    .range = {
      {.type = F_DOUBLE, .double_value = 0},
      {.type = F_DOUBLE, .double_value = 10000}
    },
  },
  {
  ...
  },
  {
    ...
    .range = {
      {.type = F_UINT16, .uint16_value = 0},
      {.type = F_UINT16, .uint16_value = 360}
    },
  },
  {
